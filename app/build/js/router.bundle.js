...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 162),
	    ReactDOM = __webpack_require__(/*! react-dom */ 1),
	    ReactRouter = __webpack_require__(/*! react-router */ 188),
	        ...
	        return (
	            React.createElement("div", null, 
	                ...
	                React.createElement("ul", null, 
	                    React.createElement("li", null, React.createElement(Link, {to: "/", activeStyle: ACTIVE}, "/")), 
	                    React.createElement("li", null, React.createElement(IndexLink, {to: "/", activeStyle: ACTIVE}, "/IndexLink")), 
	
	                    React.createElement("li", null, React.createElement(Link, {to: "/users"}, "/users")), 
	                    React.createElement("li", null, React.createElement(IndexLink, {to: "/users"}, "/users IndexLink")), 
	
	                    React.createElement("li", null, React.createElement(Link, {to: "/users/ryan", activeStyle: ACTIVE}, "/users/ryan")), 
	                    React.createElement("li", null, React.createElement(Link, {to: {pathname: "/users/ryan", query: {foo: "bar"}}, activeStyle: ACTIVE}, "/users/ryan?foo=bar")), 
	
	                    React.createElement("li", null, React.createElement(Link, {to: "/about", activeStyle: ACTIVE}, "/about"))
	                ), 
	                this.props.children
	            )
	        );
	...
	var UsersIndex = React.createClass({displayName: "UsersIndex",
	    render: function() {
	        return (
	            React.createElement("div", null, 
	                React.createElement("h2", null, "UsersIndex!")
	            )
	        );
	    }
	});
	...
	var User = React.createClass({displayName: "User",
	    render: function() {
	        return (
	            React.createElement("div", null, 
	                React.createElement("h3", null, "User ", this.props.params.id, "!")
	            )
	        );
	    }
	});
